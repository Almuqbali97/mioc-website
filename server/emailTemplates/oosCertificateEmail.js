                                ...
                                <tr style="border-collapse:collapse">
                                    <td align="center" style="padding:0;Margin:0">
                                        <table class="es-header-body"
                                            ...
                                            <tbody>
                                                <tr style="border-collapse:collapse">
                                                    <td style="padding:15px;Margin:0;background-color:#ffffff"
                                                                                    ...
                                                                                    <td class="es-m-txt-c"
                                                                                        ...
                                                                                        <a target="_blank"
                                                                                            ...
                                                                                            style="-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;text-decoration:none;color:#B0883F;font-size:14px"><img
                                                                                                src="https://i.imgur.com/01q9B4W.png"
                                                                                                alt=""
                                                ...
                                                <tr style="border-collapse:collapse">
                                                    <td style="padding:10px;Margin:0;background-color:#00000"
                                                        bgcolor="#00000" align="left">
                                                        <table width="100%" cellspacing="0" cellpadding="0" role="none"
                                                            style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px">
                                                            <tbody>
                                                                <tr style="border-collapse:collapse">
                                                                                ...
                                                                                <tr>
                                                                                    <td
                                                                                        ...
                                                                                        <div class="email-container">
                                                                                            <div class="header esd-text"
                                                                                                esd-text="true">
                                                                                                Receipt from Oman
                                                                                                Ophthalmic Society.
                                                                                            </div>
                                                                                            <div class="amount esd-text"
                                                                                                esd-text="true">
                                                                                                Fees: ${amount} OMR
                                                                                            </div>
                                                                                            <div class="date esd-text"
                                                                                                esd-text="true">
                                                                                                Issued on ${paymentDate}
                                                                                            </div>
                                                                                            <hr>

                                                                                            <div class="details esd-text"
                                                                                                esd-text="true">
                                                                                                <p>
                                                                                                    <span>Registration
                                                                                                        type:
                                                                ...
                                                                <tr style="border-collapse:collapse">
                                                                    <td valign="top" align="center"
                                                                        ...
                                                                        <table width="100%" cellspacing="0"
                                                                            ...
                                                                            <tbody>
                                                                                <tr style="border-collapse:collapse">
                                                                                    <td class="es-infoblock esd-text"
                                                                                        align="center"
