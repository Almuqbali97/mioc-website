export function oosCertificateEmailTemplate(fullName, oosId, amount, paymentDate, registrationType, orderId, paymentStatus) {
    return `<!DOCTYPE html
                        ...
                        <tr style="border-collapse:collapse">
                            <td align="center" style="padding:0;Margin:0">
                                <table class="es-header-body"
                                                                ...
                                                                <td class="es-m-txt-c" align="center" style="padding:0;Margin:0;font-size:0px">
                                                                    <a target="_blank" href="https://viewstripo.email"
                                                                        style="-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;text-decoration:none;color:#B0883F;font-size:14px"><img
                                                                            src="https://i.imgur.com/01q9B4W.png" alt=""
                                    ...
                                    <tr style="border-collapse:collapse">
                                        <td style="padding:10px;Margin:0;background-color:#000" bgcolor="#095C9F"
                                            align="left">
                                            <table width="100%" cellspacing="0" cellpadding="0" role="none"
                                                style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px">
                                                <tr style="border-collapse:collapse">
                                                            ...
                                                            <tr style="border-collapse:collapse">
                                                                <td align="center" style="padding:0;Margin:0">
                                                                    <p
                                                                        ...
                                                                        <strong>Oman Ophthalmic Society</strong>
                                                                    </p>
                                                                </td>
                                                            </tr>
                                                        </table>
                                                            ...
                                                            <tr>
                                                                <td
                                                                    ...
                                                                    <div
                                                                        ...
                                                                        <br><br>Dear ${fullName},<br><br>Greetings
                                                                        from
                                                                        <b> Oman Ophthalmic Society
                                                                            (OOS).</b>
                                                                        ...
                                                                        You can register for the Conference by visiting link below:<br><br>
                                                                                                                                    <table class="es-content" cellspacing="0" cellpadding="0" align="center" role="none"
                                                                                                                                        style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px;table-layout:fixed !important;width:100%">
                                                                                                                                        <tr style="border-collapse:collapse">
                                                                                                                                            <td align="center" style="padding:0;Margin:0">
                                                                                                                                                <table class="es-content-body" cellspacing="0" cellpadding="0" bgcolor="#ffffff" align="center" role="none"
                                                                                                                                                    style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px;background-color:#FFFFFF;width:400px">
                                                                                                                                                    <tr style="border-collapse:collapse">
                                                                                                                                                        <td style="padding:0;Margin:0;padding-top:0;padding-left:20px;padding-right:20px;padding-bottom:20px;background-color:#ffffff"
                                                                                                                                                            bgcolor="#ffffff" align="left">
                                                                                                                                                            <table width="100%" cellspacing="0" cellpadding="0" role="none"
                                                                                                                                                                style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px">
                                                                                                                                                                <tr style="border-collapse:collapse">
                                                                                                                                                                        ...
                                                                                                                                                                        <table width="100%" cellspacing="0" cellpadding="0" role="presentation"
                                                                                                                                                                            ...
                                                                                                                                                                            <tr style="border-collapse:collapse">
                                                                                                                                                                                <td align="center" style="padding:10px;Margin:0"><span
                                                                                                                                                                                        ...
                                                                                                                                                                                        style="border-style:solid;border-color:#B0883F;background:#d8a757;border-width:0px;display:inline-block;border-radius:23px;width:auto"><a
                                                                                                                                                                                            href="https://mioc.org.om/online-registration" class="es-button" target="_blank"
                                                                                                                                                                                            style="mso-style-priority:100 !important;text-decoration:none;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;color:#ffffff;font-size:17px;display:inline-block;background:#d8a757;border-radius:23px;font-family:'comic sans ms', 'marker felt-thin', arial, sans-serif;font-weight:bold;font-style:normal;line-height:20px;width:auto;text-align:center;padding:10px 25px 10px 25px;mso-padding-alt:0;mso-border-alt:10px solid #d8a757">Conference
                        ...
                        <tr style="border-collapse:collapse">
                            <td align="center" style="padding:0;Margin:0">
                                <table bgcolor="#ffffff" class="es-header-body" align="center" cellpadding="0"
                                    ...
                                    <tr style="border-collapse:collapse">
                                        <td style="Margin:0;padding-top:10px;padding-bottom:10px;padding-left:20px;padding-right:20px;background-color:#D32A18"
