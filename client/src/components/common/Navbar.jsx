...
export default function Navbar() {
    ...
    return (
        <header className="bg-white shadow-orange-500 shadow-md relative z-40 sticky top-0">
            <nav className="mx-auto flex max-w-7xl items-center justify-between p-6 lg:px-8" aria-label="Global">
                ...
                <PopoverGroup className="hidden lg:flex lg:space-x-12">
                    <Link to={"/"} className="text-sm font-semibold hover:text-blue-500 leading-6 text-gray-900">
                        Home
                    </Link>
                    ...
                    <a href="#" className="text-sm font-semibold hover:text-blue-500 leading-6 text-gray-900">
                        Marketplace
                    </a>
                    <a href="#" className="text-sm font-semibold hover:text-blue-500 leading-6 text-gray-900">
                        Company
                ...
                <div className="hidden lg:flex lg:flex-1 lg:justify-end">
                    {isLogin ? <Link to={'/logout'} className="text-sm font-semibold leading-6 text-gray-900 hover:text-red-500">
                        Logout <span aria-hidden="true">&rarr;</span>
                    </Link> : <Link to={'/login'} className="text-sm font-semibold leading-6 text-gray-900 hover:text-green-500">
