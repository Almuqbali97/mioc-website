...
const FeatureCard = ({ title, text, link, linkText }) => {
    return (
        <div className=" p-8 space-y-3 border-2 border-blue-400  dark:border-blue-300 rounded-lg myBoxShadow hover:scale-105 transition-all flex flex-col justify-between">
            <div>
                <span className="inline-block text-primary_blue dark:text-blue-400 rotate-45">
            ...
            <div>
                <Link to={link} className="inline-flex p-2 text-primary_blue capitalize transition-colors duration-200 transform bg-blue-100 rounded-full dark:bg-primary_blue dark:text-white hover:underline hover:text-blue-600 dark:hover:text-primary_blue mt-auto">
