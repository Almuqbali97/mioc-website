        ...
        <section className="flex flex-col justify-center antialiased text-gray-600 min-h-screen p-4">
            ...
            <div className="h-full">
                <div className="max-w-5xl mx-auto">
                    ...
                    <div className='flex justify-center'>
                        <div className="flex text  items-center border-l-8 border-primary_brown bg-[#d8a75736] p-4 text-emerald-900 shadow-lg relative">
                            <div className="min-w-0">
                                <h2 className="text-ellipsis whitespace-nowrap">Please select your appropriate category
                                    <span className='ml-3'>
                    ...
                    <div className='flex justify-center'>
                        <ul className="flex flex-col sm:flex-row m-7">
                            <li className="inline-flex items-center gap-x-2.5 py-3 px-4 text-sm font-medium bg-white border text-gray-800 -mt-px first:rounded-t-lg first:mt-0 last:rounded-b-lg sm:-ms-px sm:mt-0 sm:first:rounded-se-none sm:first:rounded-es-lg sm:last:rounded-es-none sm:last:rounded-se-lg dark:bg-neutral-800 dark:border-neutral-700 dark:text-white">
                                <div className="relative flex items-start w-full">
                                    <div className="flex items-center h-5">
                                        <input id="hs-horizontal-list-group-item-radio-1" name="hs-horizontal-list-group-item-radio" type="radio" className="border-gray-200 rounded-full disabled:opacity-50 dark:bg-neutral-800 dark:border-neutral-700 dark:checked:bg-blue-500 dark:checked:border-blue-500 dark:focus:ring-offset-gray-800" checked="" />
                                    </div>
                                    <label for="hs-horizontal-list-group-item-radio-1" className="ms-3 block w-full text-sm text-gray-600 dark:text-neutral-500">
                                        Ophthalmologist
                                    </label>
                                </div>
                            </li>
                            ...
                            <li className="inline-flex items-center gap-x-2.5 py-3 px-4 text-sm font-medium bg-white border text-gray-800 -mt-px first:rounded-t-lg first:mt-0 last:rounded-b-lg sm:-ms-px sm:mt-0 sm:first:rounded-se-none sm:first:rounded-es-lg sm:last:rounded-es-none sm:last:rounded-se-lg dark:bg-neutral-800 dark:border-neutral-700 dark:text-white">
                                <div className="relative flex items-start w-full">
                                    <div className="flex items-center h-5">
                                        <input id="hs-horizontal-list-group-item-radio-2" name="hs-horizontal-list-group-item-radio" type="radio" className="border-gray-200 rounded-full disabled:opacity-50 dark:bg-neutral-800 dark:border-neutral-700 dark:checked:bg-blue-500 dark:checked:border-blue-500 dark:focus:ring-offset-gray-800" />
                                    </div>
                                    <label for="hs-horizontal-list-group-item-radio-2" className="ms-3 block w-full text-sm text-gray-600 dark:text-neutral-500">
                                        Non-Ophthalmologist
                                    </label>
                                </div>
                            </li>
                            ...
                            <li className="inline-flex items-center gap-x-2.5 py-3 px-4 text-sm font-medium bg-white border text-gray-800 -mt-px first:rounded-t-lg first:mt-0 last:rounded-b-lg sm:-ms-px sm:mt-0 sm:first:rounded-se-none sm:first:rounded-es-lg sm:last:rounded-es-none sm:last:rounded-se-lg dark:bg-neutral-800 dark:border-neutral-700 dark:text-white">
                                <div className="relative flex items-start w-full">
                                    <div className="flex items-center h-5">
                                        <input id="hs-horizontal-list-group-item-radio-3" name="hs-horizontal-list-group-item-radio" type="radio" className="border-gray-200 rounded-full disabled:opacity-50 dark:bg-neutral-800 dark:border-neutral-700 dark:checked:bg-blue-500 dark:checked:border-blue-500 dark:focus:ring-offset-gray-800" />
                                    </div>
                                    <label for="hs-horizontal-list-group-item-radio-3" className="ms-3 block w-full text-sm text-gray-600 dark:text-neutral-500">
                                        Non OOS-Member
                                    </label>
                                </div>
                            </li>
                        ...
                        {/* <div className="radio-inputs">
                            <label className='flex w-32 flex-col items-center space-y-2 relative'>
                                <input
                        ...
                        {/* mouse click animation starts here */}
                        {/* <div className='click-me-animation absolute -left-5 bottom-0 '>
                                    <div className='mouse-svg w-7'>
                                        <svg viewBox="0 0 20 20" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" fill="#d8a757"><g id="SVGRepo_bgCarrier" strokeWidth="0"></g><g id="SVGRepo_tracerCarrier" strokeLinecap="round" strokeLinejoin="round"></g><g id="SVGRepo_iconCarrier"> <title>mouse_pointer [#6]</title> <desc>Created with Sketch.</desc> <defs> </defs> <g id="Page-1" stroke="none" strokeWidth="1" fill="none" fillRule="evenodd"> <g id="Dribbble-Light-Preview" transform="translate(-140.000000, -8159.000000)" fill="#d8a757"> <g id="icons" transform="translate(56.000000, 160.000000)"> <polygon id="mouse_pointer-[#6]" points="104 7999 97.075 8017.824 92.54 8013.289 86.875 8019 84 8016.125 89.711 8010.46 85.176 8005.925"> </polygon> </g> </g> </g> </g></svg>
                                    </div>
                                    <div className='circle-ping  absolute left-[71px] bottom-[70px] h-3 w-3 border-2 rounded-full'>

                                    </div>
                                </div> */}
                        {/* mouse click animation ends here */}
                        {/* </label> */}
                        ...
                        {/* <div className='m-11 w-[2px] h-[80px] bg-gray-400'></div> */}
                        {/* <div className='flex justify-center m-5 ml-0'> */}
                        {/* <div className="radio-inputs">
                            <label className='flex w-32 flex-col items-center space-y-2'>
                                <input
...
export default PricingTableSample3;
