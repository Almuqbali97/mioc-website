        ...
        <section className="flex flex-col justify-center antialiased text-gray-600 min-h-screen p-4">
            ...
            <div className="h-full">
                <div className="max-w-5xl mx-auto">
                    ...
                    <div className='flex justify-center'>
                        <ul class="flex flex-col sm:flex-row m-7">
                            ...
                            <label className='flex w-32 flex-col items-center space-y-2 relative'>
                                ...
                                {/* <div className='click-me-animation absolute -left-5 bottom-0 '>
                                    <div className='mouse-svg w-7'>
                                        <svg viewBox="0 0 20 20" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" fill="#d8a757"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"> <title>mouse_pointer [#6]</title> <desc>Created with Sketch.</desc> <defs> </defs> <g id="Page-1" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd"> <g id="Dribbble-Light-Preview" transform="translate(-140.000000, -8159.000000)" fill="#d8a757"> <g id="icons" transform="translate(56.000000, 160.000000)"> <polygon id="mouse_pointer-[#6]" points="104 7999 97.075 8017.824 92.54 8013.289 86.875 8019 84 8016.125 89.711 8010.46 85.176 8005.925"> </polygon> </g> </g> </g> </g></svg>
                                    </div>
                                ...
                                <span className="radio-tile">
                                    <span className="radio-icon relative">
                                        <span className="absolute scale-110 inset-0">
                                            <svg viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" fill="none" stroke="#ffffff"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"> <path stroke="#ffffff" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8.5 23.5l15-15M23.5 23.5l-15-15"></path> </g></svg>
                                        </span>
