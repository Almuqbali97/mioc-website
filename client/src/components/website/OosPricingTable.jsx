                                    ...
                                    {[
                                        ...
                                        <div key={card.title} className="relative max-w-[350px] bg-white shadow-2xl rounded-sm border border-gray-200">
                                            ...
                                            <div className="px-5 pt-5 pb-6 border-b border-gray-200">
                                                ...
                                                <p className=' font-light'>{card.title === 'Non-Ophthalmologist' && 'Residents, Optometrist, Ophthalmic technician, Nursing, Allied health care'}</p>
                                                ...
                                                <div className="text-gray-800 font-bold mb-4">
                                                    <span className="text-red-400 text-2xl line-through font-semibold ">{card.title === 'Ophthalmologist' ? '35/OMR' : '20 /OMR'}</span>
                                                    <br />
