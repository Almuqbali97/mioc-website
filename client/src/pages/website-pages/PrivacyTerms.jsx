        ...
        <div className='max-w-7xl mx-auto'>
            <section className="container mx-auto px-4 py-8">
                ...
                <ul className="list-disc list-inside ml-4 mb-4">
                    ...
                    <li><strong>Company</strong> (referred to as either "the Company,” “We," “Us," or "Our" in this Agreement) refers to The Muscat International Ophthalmology Conference.</li>
                    ...
                    <li><strong>Country</strong> refers to the Sultanate of Oman.</li>
                    ...
                    <li><strong>Usage Data</strong> refers to data collected automatically, either generated by the Service or from the Service infrastructure itself (for example, the duration of a page visit).</li>
                    <li><strong>Website</strong> refers to The Muscat International Ophthalmology Conference, accessible from <a href="https://mioc.org.om/" className="text-blue-600 hover:underline">https://mioc.org.om/</a></li>
                    <li><strong>You</strong> mean the individual accessing or using the Service, the company, or other legal entity on behalf of which such individual is accessing or using the Service, as applicable.</li>
                </ul>
                ...
                <h4 className="text-lg font-semibold mt-4 mb-2">1. Personal Data</h4>
                <p className="mb-4">
                ...
                <h4 className="text-lg font-semibold mt-4 mb-2">2. Usage Data</h4>
                <p className="mb-4">
                ...
                <h4 className="text-lg font-semibold mt-4 mb-2">3. Information from Third-Party Social Media Services</h4>
                <p className="mb-4">
                ...
                <ul className="list-disc list-inside ml-4 mb-4">
                    ...
                    <li><strong>Flash Cookies:</strong> Certain features of our Service may use local stored objects (or Flash cookies) to collect and store information about Your preferences or activity on our Service. Flash Cookies are not managed by the same browser settings as those used for Browser Cookies. For more information on how To delete Flash Cookies, please read "Where can I change the settings for disabling or deleting local shared objects?" available at <a href="https://helpx.adobe.com/flash-player/kb/disable-local-shared-objects-flash.html#main_Where_can_I_change_the_settings_for_disabling__or_deleting_local_shared_objects_" className="text-blue-600 hover:underline">Adobe Flash Player Help</a>.</li>
                ...
                <ul className="list-disc list-inside ml-4 mb-4">
                    <li>
                        ...
                        <ul className="list-disc list-inside ml-4 mb-4">
                            ...
                            <li><strong>Purpose:</strong> These cookies are essential to provide You with services available through the Website and enable You to use some of its features. They help to authenticate users and prevent fraudulent use of user accounts. Without these Cookies, the services that You have asked for cannot be provided, and We only use these Cookies to offer you those services.</li>
                        </ul>
                    </li>
                    <li>
                    ...
                    <li>
                        ...
                        <ul className="list-disc list-inside ml-4 mb-4">
                            <li><strong>Type:</strong> Persistent Cookies</li>
                            <li><strong>Administered by:</strong> Us</li>
                            <li><strong>Purpose:</strong> These cookies allow us to remember choices You make when You use the Website, such as remembering your login details or language preference. These cookies provide You with a more personal experience and avoid You having to re-enter your preferences every time You use the Website.</li>
                        </ul>
                    </li>
                </ul>
                <p className="mb-4">
                ...
                <ul className="list-disc list-inside ml-4 mb-4">
                    ...
                    <li>For business transfers: We may use Your information to evaluate or conduct a merger, divestiture, restructuring, reorganization, dissolution, or another sale or transfer of some or all of Our assets, whether as a going concern or as part of bankruptcy, liquidation, or similar proceeding, in which Personal Data held by Us about our Service users is among the assets transferred.</li>
                ...
                <h2 className="text-2xl font-semibold mt-8 mb-4">Sharing Your Personal Data</h2>
                <p className="mb-4">
                ...
                <ul className="list-disc list-inside ml-4 mb-4">
                    <li>By visiting this page on our website: <a href="https://mioc.org.om/" className="text-blue-600 hover:underline">https://mioc.org.om/</a></li>
                </ul>
            </section>
