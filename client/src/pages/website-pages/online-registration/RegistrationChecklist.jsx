    ...
    return (
        <div>
            ...
            <ContentContainer>
                ...
                <CommonParagraph>
                    Please follow the below process to register for MIOC-EMCO-IKS 2024. You can create a profile using your email address or social media account and can always return back to update, edit or add services to your profile.
                </CommonParagraph>
                <CommonParagraph>
                ...
                <CommonParagraph>
                    You will be asked a series of demographic questions. Your answers will be kept confidential and will help us ensure that future MIOC-EMCO-IKS 2024 meets your educational needs.
                </CommonParagraph>
                <ParagraphTitle title={'Step 4: Package Selection'} />
                <CommonParagraph>
                    Step 4: Package Selection
                    You will register for MIOC-EMCO-IKS 2024 and choose the registration category applicable for you. View <span className='text-primary_brown font-bold'><Link to='/online-registration'>Registration categories and prices</Link></span>
                </CommonParagraph>
                ...
                <CommonParagraph>You must be registered for MIOC-EMCO-IKS 2024 in order to book your accommodation. For questions about registration or housing, please contact <span className='text-primary_brown font-bold'>info@mioc.org.om</span></CommonParagraph>
            </ContentContainer>
        </div>
    );
}
